...
**Issue 3 — SFColor constructor not available as global**  
`new SFColor(r, g, b)` throws `SFColor is not defined`. Workaround: use
plain arrays `[r, g, b]` for SFColor field assignment.
